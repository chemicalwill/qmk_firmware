...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_META] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, BENZO,   _______, _______, _______, _______, _______, \
        _______, ACEIDM,  STATIN,  _______, _______, GLIM,    HFACEI,  _______, _______, LOPID,   _______, _______,          _______, _______, \
        _______, _______, _______, COA,     _______, BETAB,   _______, _______, _______, _______, _______, _______,          _______, _______, \
